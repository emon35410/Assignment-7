...
const Banner = ({ selectedTicket, selectedComplete, setSelectedComplete }) => {
    return (
        <div className='flex flex-col  md:flex-row justify-center-safe gap-6 mt-20'>
            ...
            >
                <div className='flex flex-col justify-center items-center gap-1 text-white'>
                    <h3>In-Progress</h3>
                    <h1 className='font-semibold text-5xl'>{Math.max(0, selectedTicket.length - (setSelectedComplete.length - 1))}</h1>
                </div>
            </div>
